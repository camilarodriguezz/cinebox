...
export default function Detail(props) {
    ...
    const rateClicked = () => {
        if (highlight > 0 && highlight < 6) {
            fetch(`http://10.0.0.197:8000/api/movies/${movie.id}/rate_movie/`, {
                method: 'POST',
                headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.starContainer}>
                <FontAwesomeIcon style={highlight > 0 ? styles.green : styles.black} icon={faStar} size={48} onPress={() => setHighlight(1)} />
                <FontAwesomeIcon style={highlight > 1 ? styles.green : styles.black} icon={faStar} size={48} onPress={() => setHighlight(2)} />
                <FontAwesomeIcon style={highlight > 2 ? styles.green : styles.black} icon={faStar} size={48} onPress={() => setHighlight(3)} />
                <FontAwesomeIcon style={highlight > 3 ? styles.green : styles.black} icon={faStar} size={48} onPress={() => setHighlight(4)} />
                <FontAwesomeIcon style={highlight > 4 ? styles.green : styles.black} icon={faStar} size={48} onPress={() => setHighlight(5)} />
            </View>
